...
const Navbar = () => {
  return (
    <nav className="items-center flex min-h-[73px] w-full font-normal flex-wrap bg-[#F8F9FA] px-3 py-[17px]">
      <img
        src="https://api.builder.io/api/v1/image/assets/6d43413510a04e5f9626f79bfdfe061c/74e3aee1c78f811a10ead1a1b0917e5c41cff3b1?placeholderIfAbsent=true"
      ...
      <div className="items-center self-stretch flex min-w-60 text-base text-[#029C58] flex-1 shrink basis-8 bg-[rgba(255,255,255,0.00)] my-auto max-md:max-w-full">
