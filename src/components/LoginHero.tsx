    ...
    <main className="w-full max-w-[1670px] ml-[70px] mt-[110px] max-md:max-w-full max-md:mt-10 max-md:ml-4">
      <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
        <div className="w-[46%] max-md:w-full max-md:ml-0">
          <img
            src="https://api.builder.io/api/v1/image/assets/6d43413510a04e5f9626f79bfdfe061c/67230a190448214b3b7b1d351c5a6186fae42fdb?placeholderIfAbsent=true"
        ...
        <div className="w-[54%] ml-5 max-md:w-full max-md:ml-0">
          <div className="flex w-full flex-col self-stretch items-center text-base font-normal my-auto max-md:max-w-full max-md:mt-10">
            ...
            <section className="justify-center items-stretch self-stretch flex w-full flex-col overflow-hidden text-[#212529] text-justify leading-6 bg-[rgba(255,255,255,0.00)] mt-10 max-md:max-w-full">
            ...
            <button 
              ...
              className="bg-[rgba(2,156,88,1)] border flex items-center gap-2 overflow-hidden text-white justify-center mt-10 px-3 py-1.5 rounded-md border-[rgba(2,156,88,1)] border-solid hover:bg-[rgba(2,156,88,0.9)] transition-colors focus:outline-none focus:ring-2 focus:ring-[rgba(2,156,88,0.5)] focus:ring-offset-2"
              aria-label="Realizar login no sistema"
            >
